...
@implementation IMRegisterData

@end

@implementation IMDemoRegisterTask

- (NSURLRequest *)taskRequest
{
    NSString *urlString = [[[IMDemoConfig sharedConfig] apiURL] stringByAppendingString:@"/createDemoUser"];
