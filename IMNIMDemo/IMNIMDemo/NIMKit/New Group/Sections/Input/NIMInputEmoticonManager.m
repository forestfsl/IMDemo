...
- (NIMInputEmoticon *)emoticonByCatalogID:(NSString *)catalogID emoticonID:(NSString *)emoticonID
{
    NIMInputEmoticon *emoticon = nil;
...
- (void)parsePlist
{
    ...
    if (filepath) {
        ...
        for (NSDictionary *dict in array) {
            ...
            NIMInputEmoticonCatalog *catalog = [self catalogByInfo:info emoticons:emoticons];
...
- (NIMInputEmoticonCatalog *)catalogByInfo:(NSDictionary *)info emoticons:(NSArray *)emoticonsArray{
